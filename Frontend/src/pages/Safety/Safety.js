    ...
    return (
        <Fragment>
            ...
            <Grid container spacing={0} className={classes.whiteContainerStyle} alignItems='center' justify='center'>
                <Grid item xs={12} sm={12} md={8} lg={8} xl={8} className={classes.greetingContentGridStyle}>
            ...
            <Grid container spacing={0} className={classes.greyContainerStyle} alignItems='center' justify='center'>
                ...
                <Grid item xs={12} sm={12} md={6} lg={6} xl={6} container spacing={0} className={classes.ourPriciplesContainerStyle} direction='column'>
