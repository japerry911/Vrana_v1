...
const RetailTab = () => {
    ...
    const parkingStructureProjects = useSelector(state => state.projects.projects.parkingStructures);
    const isEven = parkingStructureProjects.length % 2 === 0;
    ...
    return (
        <div className={classes.whiteContainerStyle}>
            <Grid container spacing={0} justify='center'>
                ...
                {isEven
                ?
                parkingStructureProjects.map((project, index) => {
                ...
                parkingStructureProjects.map((project, index) => {
                    ...
                    if (index === parkingStructureProjects.length - 1) {
                        return (
