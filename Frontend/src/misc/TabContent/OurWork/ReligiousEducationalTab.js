...
const RetailTab = () => {
    ...
    const religiousEducationalProjects = useSelector(state => state.projects.projects.religiousEducational);
    const isEven = religiousEducationalProjects.length % 2 === 0;
    ...
    return (
        <div className={classes.whiteContainerStyle}>
            <Grid container spacing={0} justify='center'>
                ...
                {isEven
                ?
                religiousEducationalProjects.map((project, index) => {
                ...
                religiousEducationalProjects.map((project, index) => {
                    ...
                    if (index === religiousEducationalProjects.length - 1) {
                        return (
